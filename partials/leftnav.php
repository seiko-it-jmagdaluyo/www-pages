<a href="javascript:void(0);" class="leftnavicon icon" onclick="toggleLeftNav()">&#9776;</a>
        ...
        <dl id="slider">
            ...
            <dd>
                <ul class="menu">
                    ...
                    <li><a href="introduction_index02.html">主な活動内容</a></li>
            ...
            <dd>
                <ul class="menu">
                    ...
                    <!--
                    <li><a href="seminar_detail.html">最新のセミナー</a></li>
                    <li><a href="seminar_detail.html">今後開催予定のセミナー</a></li>
                    <li><a href="seminar_detail.html">過去に開催したセミナー</a></li>
                    -->
                </ul>
            </dd>
            ...
            <dd>
                <ul class="menu">
                    ...
                    <li><a href="memberenterprise_detail.php?cg_id=4">商事</a></li>
                    <li><a href="memberenterprise_detail.php?cg_id=5">製造・加工</a></li>
                    <li><a href="memberenterprise_detail.php?cg_id=6">銀行・保険</a></li>
                    <li><a href="memberenterprise_detail.php?cg_id=7">運輸・通信</a></li>
                    <li><a href="memberenterprise_detail.php?cg_id=8">諸企業</a></li>
                    <li><a href="memberenterprise_detail.php?cg_id=9">特別会員</a></li>
                    <li><a href="memberenterprise_detail.php">五十音順</a></li>
                </ul>
            </dd>
        </dl>
